            ...
            <div className="grid md:grid-cols-2 gap-14 items-center">
              ...
              <div>
                <div className="anim-0 inline-flex items-center gap-2 text-xs font-bold px-3.5 py-1.5 rounded-full mb-6 border"
                  ...
                  AI chấm theo rubric chính thức của NIIED (Viện Giáo dục Quốc tế Hàn Quốc)
                </div>
                ...
                <p className="anim-2 text-lg text-[#6E6E73] leading-relaxed mb-8 max-w-[440px]">
                  App luyện viết Q51-54 duy nhất cho người Việt. AI chấm tức thì, feedback 100% tiếng Việt, rubric chuẩn của NIIED (Viện Giáo dục Quốc tế Hàn Quốc).
                </p>
              ...
              <div className="feat-card rounded-2xl p-8 flex flex-col justify-between min-h-[280px] cursor-default"
                ...
                <div>
                  <h3 className="text-2xl font-extrabold mb-3 leading-snug tracking-tight"
                    style={{ color: "#FFFFFF" }}>
                    Chấm <span style={{ color: "#93C5FD" }}>4 tiêu chí của NIIED (Viện Giáo dục Quốc tế Hàn Quốc)</span> tách biệt — không gộp chung một điểm
                  </h3>
              ...
              {[
                {
                  ...
                  answer: "AI dùng đúng rubric của NIIED (Viện Giáo dục Quốc tế Hàn Quốc) — không tự đoán",
                  detail: "4 tiêu chí Nội dung, Tổ chức, Ngữ pháp, Phong cách là cố định do NIIED (Viện Giáo dục Quốc tế Hàn Quốc) ban hành. AI áp dụng đúng bảng này — cùng tiêu chuẩn hội đồng thi dùng.",
                ...
                },
                {
                  ...
                  detail: "Giáo viên cũng có cảm tính riêng. Điểm thi thật do hội đồng NIIED (Viện Giáo dục Quốc tế Hàn Quốc) quyết định theo rubric cố định — AI dùng đúng rubric đó, mỗi bài đều như nhau.",
            ...
            <div className="grid md:grid-cols-3 gap-6 relative">
              ...
              {[
                ...
                },
                {
                  ...
                  desc: "Nhận điểm 4 tiêu chí của NIIED (Viện Giáo dục Quốc tế Hàn Quốc), gợi ý cải thiện cụ thể, so sánh bài mẫu ngay lập tức.",
                },
                {
            ...
            <table className="w-full text-sm min-w-[540px]">
              ...
              <tbody className="divide-y divide-gray-50">
                {[
                  ...
                  ["4 tiêu chí NIIED (Viện Giáo dục Quốc tế Hàn Quốc)",      "check",             "check",                "x"],
                  ["원고지 thật",            "check",             "x",                    "x"],
