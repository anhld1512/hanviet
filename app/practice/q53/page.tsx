        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-center text-xs text-gray-400">Tối đa 30 điểm · AI chấm theo rubric của NIIED (Viện Giáo dục Quốc tế Hàn Quốc — cơ quan tổ chức kỳ thi TOPIK)</p>
            </div>
          </div>
        </div>
        </main>
