    ...
    return (
      ...
      <BottomNav />
        ...
        <div className="w-full">
          ...
          <GradingResult result={gradeResult} onRetry={() => { clearResult("q53", selected.id); setGradeResult(null); setAnswer("") }} onNext={backToList} userAnswer={answer} />
        </div>
        </main>
      </div>
    )
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="ml-0 md:ml-56 flex-1 p-4 md:p-8 pb-20 md:pb-8">
        ...
        />
        <div className="mt-6"><PracticeTips data={TIPS_Q53} /></div>
        </div>
      </main>
    </div>
  )
