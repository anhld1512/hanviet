...
export default function FloatingCTA() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-xs font-medium text-blue-100 mb-1">Học nghiêm túc hơn?</span>
        <span className="font-bold text-base leading-tight text-center">Sẵn sàng học nghiêm túc?</span>
